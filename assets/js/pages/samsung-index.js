...
try {
const querySnapshot = await getDocs(samsungCollection);
...
const deviceLink = `https://secondhandcell.com/sell?device=samsung-galaxy-${slug}`;
...
if (phoneData) {
const slug = createUrlSlug(phoneData.name);
window.location.href = `https://secondhandcell.com/sell?device=samsung-galaxy-${slug}`;
}
});
