...
import { adminDb, FirebaseAdminNotConfiguredError } from '../../lib/firebaseAdmin';
...
export default async function AdminOrdersPage() {
  ...
  try {
    ...
    if (error instanceof FirebaseAdminNotConfiguredError) {
      console.warn('Falling back to sample orders because Firebase admin is not configured.');
    } else {
