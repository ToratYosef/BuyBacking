...
const LABEL_CANCELED_EMAIL_HTML = `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Your SecondHandCell Shipping Label Update</title><style>body{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif;background-color:#f4f4f4;margin:0;padding:0}.email-container{max-width:600px;margin:20px auto;background-color:#ffffff;border-radius:12px;box-shadow:0 10px 30px rgba(15,23,42,0.12);overflow:hidden;border:1px solid #e2e8f0}.header{background:linear-gradient(135deg,#0f172a,#1e40af);color:#ffffff;padding:28px;text-align:center}.header h1{font-size:24px;margin:0}.content{padding:26px 28px 30px;color:#1f2937;font-size:16px;line-height:1.7}.content p{margin:0 0 18px}.order-id{color:#1d4ed8;font-weight:600}.callout{background-color:#eff6ff;border-left:4px solid #3b82f6;padding:18px 20px;border-radius:10px;margin:24px 0}.footer{padding:22px;text-align:center;color:#6b7280;font-size:14px;border-top:1px solid #e2e8f0}</style></head><body><div class="email-container"><div class="header"><h1>Shipping Label Canceled</h1></div><div class="content"><p>Hello **CUSTOMER_NAME**,</p><p>We wanted to let you know that the prepaid shipping label for order <strong class="order-id">#**ORDER_ID**</strong> has been canceled because the device was not placed in transit.</p><div class="callout"><p>If you still plan on sending your device, reply to this email and we'll generate a fresh label right away. We're happy to reactivate your order whenever you are ready.</p></div><p>No further action is needed from you at this time. When you're ready to continue, just reach out so we can get a new kit or label issued.</p><p>Thank you for choosing SecondHandCell.</p><p style="margin-bottom:0;">&mdash; The SecondHandCell Team</p></div><div class="footer"><p>If you have any questions, simply reply to this email and our team will assist you.</p></div></div></body></html>`;
